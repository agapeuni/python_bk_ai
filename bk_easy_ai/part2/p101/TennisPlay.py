...
# 입력은 라켓 각도, 공을 치는 힘, 네트와의 거리
# 3X3X1의 인공신경망 만들기
# 입력부에 1을 추가하여 bias 대체
# 출력부 활성화 함수로 하이퍼볼릭 탄젠트 함수(tanh function) 사용
...
# 입력(input)값과 정답(teaching data) 데이터 지정
input_data = np.array([[80,6,10], [45,10,5], [70,8,9], [60,6,8], [60,5,3], [50,5,4], [60,7,7]])
teaching_data = np.array([[-0.5], [1], [0.1], [0.05], [-0.1], [0.5], [0]])
...
x1 = 80/90          # 라켓의 각도(많이 세운 상태, 최대90도 중, 80도)
