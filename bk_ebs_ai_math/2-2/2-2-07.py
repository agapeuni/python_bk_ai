...
# image file 읽어오기
im1 = pilimg.open("bk_ebs_ai/2-2/jeju_summer.jpg")          # 배경 이미지 열기
im2 = pilimg.open("bk_ebs_ai/2-2/baby1.jpg")                # 조카 이미지1  열기
im3 = pilimg.open("bk_ebs_ai/2-2/baby2.jpg")                # 조카 이미지2  열기
