...
for i in range(0, len(ice_buy)):
    print('%0.2f' % ice_buy_a[i])          # 아이스크림 쇼핑 클릭량의 평균을 소수점 둘째 자리까지 출력하기
