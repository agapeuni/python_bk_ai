...
# 행렬 및 벡터 데이터 관리를 위한 numpy 모듈
import numpy as np
# 소리 데이터의 그래프 표현을 위한 모듈
import matplotlib.pyplot as plt
import scipy.io as sio
# wav 파일을 시스템 명령어로 재생하기 위한 모듈
...
write('bk_ebs_ai/2-3/music_card.wav', sr, scaled)
os.system("start bk_ebs_ai/2-3/music_card.wav")
